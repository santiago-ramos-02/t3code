 ...
 *
 * v5 added `grok` and v6 adds `pi` to {@link UsageProviderKind}. Both changes
 * are additive, so v4 Claude/Codex buckets remain valid and mixed-version
 * environments keep those totals instead of treating older servers as stale.
 */
